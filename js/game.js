            ...
            switch (this.currentPhase) {
                case this.PHASE_GAME_OVER:
                    ...
                    if (!this.gameIsOver()) {
                        ...
                        utils.info(alert("The game is finished !"));
                    }
                    break;
        ...
        fire: function (from, col, line, callback) {
            ...
            target.receiveAttack(col, line, function (hasSucceed) {
                if (hasSucceed === 'alreadyHit') {
                    msg += "Tiré touché au même endroit";
                    setTimeout(function () {
                        utils.sounds['hit'].play();
                    }, 1000);
                }
                else if (hasSucceed === 'alreadyMiss') {
                    msg += "Tire raté au même endroit.";
                    setTimeout(function () {
                        utils.sounds['missed'].play();
                    }, 1000);
                }
                else if (hasSucceed === 'sunk') {
                    msg += "Tu coule ! Ma poule !";
                    setTimeout(function () {
                        utils.sounds['hit'].play();
                        utils.sounds['hit_voice2'].play();
                    }, 1000);
                }
                else if (hasSucceed) {
                    msg += "Hit !";
